...
<script>
  ...
  function sendMessage(element, username, eventTitle){
    ...
    $.ajax({
      type: "GET",
      url: "createPrivateGroup.php?UID="+UID+"&username="+username+"&eventTitle="+eventTitle,
      success: function (response){
  ...
  function showHome(element){
    ...
    $.ajax({
      type: "GET",
      url: "changeHomePageDestination.php?UID="+UID,
      success: function (response){
  ...
  function sendRequestToJoinGroup(eventTitle, groupName){
    ...
    $.ajax({
      type: "POST",
      url: "sendRequestToJoinGroup.php",
      data: {
