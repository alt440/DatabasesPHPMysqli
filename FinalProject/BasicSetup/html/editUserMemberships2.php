...
?>
<!--
  authors: Alexandre Therrien, Daniel Vigny-Pau, Francois David
-->
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <table class="centeredRow" id="userMemberships">
    ...
    function dropGroupMembership(username, element){
      ...
      $.ajax({
        type: "GET",
        url: "dropGroupMembership.php?groupID="+groupID+"&username="+username,
    ...
    function dropEventMembership(username, element){
      ...
      $.ajax({
        type: "GET",
        url: "dropEventMembership.php?eventID="+eventID+"&username="+username,
        success: function (response){
          location.reload();
        }
      });
    ...
    function dropEvent(username, element){
      ...
      $.ajax({
        type: "GET",
        url: "deleteEvent.php?eventID="+eventID+"&username="+username,
        success: function (response){
          location.reload();
        }
      });
    ...
    function dropGroup(username, element){
      ...
      $.ajax({
        type: "GET",
        url: "deleteGroup.php?groupID="+groupID+"&username="+username,
        success: function (response){
          location.reload();
        }
      });
    ...
    function addEvent(username){
      ...
      $.ajax({
        type: "GET",
        url: "addEvent.php?username="+username+"&templateNb="+templateSelected+"&eventTitle="+eventTitle+"&eventType="+strUser,
        success: function (response){
